...
<form:form id="regForm" modelAttribute="order" action="/AcademiaHybris_war/order/save" method="post">
            ...
            <div class="flex-layout">
                <div class="flex-row">
                    <div class="flex-group">
                        <div class="flex-col"><form:label path="user">Cliente</form:label></div>
                        <div class="flex-col">
                            <form:select path="user.id" multiple="false" class="select-size" disabled="${disabled}">
                                <form:options items="${customer}" itemValue="id" itemLabel="name"/>
                            </form:select>
                        </div>
                    </div>
            ...
            <div class="flex-layout">
                ...
                <div class="flex-row">
                    ...
                    <div class="flex-group">
                        ...
                        <div class="flex-col">
                            <input type="text" class="js-quantidade" ${deleted ? 'disabled="true"' :'' }"/>
                        </div>
                    </div>
                    <div class="flex-group">
                        <div class="flex-col">
